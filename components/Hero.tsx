...
export function Hero({ totalResources }: HeroProps) {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 min-h-[50vh] md:min-h-[60vh] 2xl:min-h-[25vh]">
        <div className="lg:col-span-8 flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-border p-6 md:p-10 lg:p-14">
          ...
          <div className="mt-16 lg:mt-0 pt-8 lg:pt-12 w-full">
            ...
            <div className="w-full h-px bg-linear-to-r from-foreground/20 via-foreground/5 to-transparent mt-8" />

            {totalResources !== undefined && totalResources > 0 && (
        ...
        <div className="lg:col-span-4 flex flex-col justify-between p-6 md:p-10 lg:p-14 bg-muted/20 relative">
          <div className="absolute inset-0 dot-pattern pointer-events-none" />
          
          <div className="flex justify-end mb-12 lg:mb-0 relative">
          ...
          <div className="mt-auto relative">
            ...
            <div className="flex items-center gap-4 font-mono text-[10px] sm:text-xs font-bold uppercase tracking-widest group cursor-default">
              <div className="flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center border border-foreground bg-foreground text-background transition-colors group-hover:bg-background group-hover:text-foreground animate-float-bounce">
